  ...
  function handleFiles(event) {
    ...
    Array.from(files).forEach((file) => {
      ...
      reader.onload = function(e) {
        ...
        preview.className = "flex items-center justify-between gap-4 p-3 border border-neutral-300 rounded-lg hover:bg-neutral-50 hover:border-primary transition-all duration-500 ease-in-out";
