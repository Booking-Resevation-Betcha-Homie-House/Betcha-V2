...
function getAmenityIconFromModal(iconType) {
    ...
    const iconMap = {
        ...
        'iron': '/svg/iron.svg',
        'pillow': '/svg/extraPillowsBlanket.svg',
        'towel': '/svg/towel.svg',
        'microwave': '/svg/microwave.svg',
        'stove': '/svg/stove.svg',
        'oven': '/svg/oven.svg',
        'coffee': '/svg/coffeeMaker.svg',
        'toaster': '/svg/toaster.svg',
        'pots': '/svg/pan.svg',
        'spices': '/svg/salt.svg',
        'dishes': '/svg/dishes.svg',
        'table': '/svg/diningtable.svg',
        ...
        'dryer': '/svg/dryer.svg',
        'dryingRack': '/svg/ironBoard.svg',
        'ironBoard': '/svg/ironBoard.svg',
        'cleaning': '/svg/detergent.svg',
        'speaker': '/svg/speaker.svg',
        'gamepad': '/svg/console.svg',
        'chess': '/svg/chess.svg',
        'cards': '/svg/card.svg',
        'billiard': '/svg/chess.svg',
        'fireExtinguisher': '/svg/fireExtinguisher.svg',
        'firstAid': '/svg/firstAidKit.svg',
        'cctv': '/svg/cctv.svg',
        ...
        'pool': '/svg/pool.svg',
        'petBowl': '/svg/bowl.svg',
        'petBed': '/svg/bed.svg',
        'babyBath': '/svg/bath.svg',
        'default': '/svg/add.svg'
    };
