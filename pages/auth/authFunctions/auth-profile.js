...
function initializeAuthProfile() {
    try {
        ...
        const imgElement = document.getElementById('authProfileImg');
        if (imgElement) {
        ...
        if (profilePicture && profilePicture.trim() !== '') {
            ...
            console.log('Auth profile picture loaded as background:', profilePicture);
        } else {
            ...
            console.log('No auth profile picture, using default icon');
        }
